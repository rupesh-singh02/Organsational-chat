                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            <h5 class="text-primary">Welcome Back! Admin Sign In</h5>
                                            <p class="text-muted">Sign in to continue to Skyvoice.</p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <form id="loginForm" method="post">
                                                ...
                                                <div class="mb-3">
                                                    <div class="float-end">
                                                        <a href="forgotpassword.html" class="text-muted">Forgot
                                                            password?</a>
                                                    </div>
                                                ...
                                                <div class="mt-4">
                                                    <button class="btn btn-secondary w-100" type="submit">Sign
                                                        In</button>
                                                </div>
